                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-12">
                            <h4 className="my-subheading dh4">browse our terms</h4>
                            <h2 className="my-heading dh2">terms and <span className="my-red">conditions</span></h2>
                        </div>
                    </div>
                            ...
                            <div id="accordion2">
                                ...
                                <div className="card">
                                    <div className="card-header">
                                        <a className="card-link" data-toggle="collapse" href="#terms1">Terms & Conditions</a>
                                    </div>
                                    <div id="terms1" className="collapse show" data-parent="#accordion2">
                                        <div className="card-body">
                                            <p>he terms "We" / "Us" / "Our"/”Company” individually and collectively refer to BYTV and the terms "Visitor” ”User” refer to the users.</p>
                                ...
                                <div className="card">
                                    <div className="card-header">
                                        <a className="card-link" data-toggle="collapse" href="#terms2">USE OF CONTENT</a>
                                    </div>
                                    <div id="terms2" className="collapse" data-parent="#accordion2">
                                        <div className="card-body">
                                ...
                                <div className="card">
                                    <div className="card-header">
                                        <a className="card-link" data-toggle="collapse" href="#terms3">ACCEPTABLE WEBSITE USE</a>
                                    </div>
                                    <div id="terms3" className="collapse" data-parent="#accordion2">
                                        <div className="card-body">
                                            <p>(A) Security Rules
                                ...
                                <div className="card">
                                    <div className="card-header">
                                        <a className="card-link" data-toggle="collapse" href="#terms5">LIABILITY</a>
                                    </div>
                                    <div id="terms5" className="collapse" data-parent="#accordion2">
                                        <div className="card-body">
                                ...
                                <div className="card">
                                    <div className="card-header">
                                        <a className="card-link" data-toggle="collapse" href="#terms6">DISCLAIMER OF CONSEQUENTIAL DAMAGES</a>
                                    </div>
                                    <div id="terms6" className="collapse" data-parent="#accordion2">
                                        <div className="card-body">
